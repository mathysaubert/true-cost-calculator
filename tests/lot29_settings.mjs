...
console.log("\n── 3. Recopie, fiabilité, état des réglages ──");
{
  ...
  ok(settingsStatus({ settings: { profitability_threshold_pct: 0 }, fixedCosts: [], gateways: [], day: "2026-09-24" }).find((i) => i.id === "cm2_target").state === "set", "D2-4 : objectif 0 % choisi = renseigné (seul NULL = non renseigné)");
